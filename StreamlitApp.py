...
from src.mcq_generator.mcq_generator import sequential_chain
...
with st.form('user input'):
    ...
    mcq_count = st.number_input("number of mcq's", min_value = 5, max_value = 50)

    subject = st.text_input("Insert Subject", max_chars=25)

    tone = st.text_input("Complexity Level of Question", max_chars=25, placeholder="Simple")
